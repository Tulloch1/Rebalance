...
4. **All Tests Green:** Run `node tests/master_test_suite.js` (136 tests) and `node tests/backend_test_suite.js` (23 tests) before finishing any task. All 159 tests must pass.
